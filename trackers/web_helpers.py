...
class ProcessedStaticManager(object):
    ...
    ResourceProcessed = namedtuple(
        "ResourceProcessed",
        ["use_hased_url", "cache_control", "url", "hash", "response_kwarg"],
    )
    ...
    def __init__(self, app, package, resources_processed=()):
        ...
        self.urls = {}
        self.resources_processed = Observable(
    ...
    def add_resource(
        ...
        **response_kwarg,
        ...
        self.app.router.add_route(
            "GET",
            route,
            coro_partial(self.resource_handler, route_name),
            name=route_name,
        )
    ...
    def add_resource_dir(
        ...
        **response_kwarg,
        ...
        self.resources.append(
            self.ResourceDir(
                resource_name, route_name, use_hased_url, cache_control, response_kwarg
            )
        )
        self.app.router.add_route(
            "GET",
    ...
    async def process_resources(self, watcher=None):
        ...
        for resource in expanded_resources:
            ...
            if resource.use_hased_url:
                url = (
                    self.app.router[resource.route_name]
                    .url_for(**resource.url_for_kwargs)
