...
from trackers.sources.tkstorage import ZC03_parse, data_split, msg_item_to_point
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1525366678,
                    1,
                    "(864768011199921,ZC20,030518,165713,6,402,65535,255)",
                    "TK00",
                ]
            ),
            {
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1526394347,
                    1,
                    "(864768011193965,DW30,150518,A,2605.6699S,02756.5543E,0.20,142539,0.00,1604.20,12)",
                    "TK01",
                ]
            ),
            {
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1526394347,
                    1,
                    "(864768011468102,DW30,080618,A,2752.87996S,02755.19665E,1.910,202919,000.0,1538.20,12,0)",
                    "TK01",
                ]
            ),
            {
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1528548291.011041,
                    1,
                    "(864768011199962,DW3B,050316,A,2754.4558S,02759.0423E,6.82,124449,279.65,1537.50,10,0)",
                    "TK05",
                ]
            ),
            {
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1528548291.011041,
                    1,
                    "(864768011199962,DW3B,050316,A,2754.4558S,02759.0423E,6.82,124449,279.65,0,10,0)",
                    "TK05",
                ]
            ),
            {
        ...
        self.assertEqual(
            msg_item_to_point(
                [
                    ...
                    1,
                    "(864768011468169,DW3B,000000,A,3124.00405S,02355.82419E,9.061,215900,190.21,1273.30,11,0)",
                    "TK05",
                ]
            ),
            {
            ...
            self.assertEqual(
                msg_item_to_point(
                    [
                        ...
                        1526394226,
                        1,
                        "(864768011193965,ZC03,150518,142343,$stuff$)",
                        "TK01",
                    ]
                ),
                {
    ...
    def test_status(self):
        self.assertEqual(
            ...
            ),
            {
                ...
                "tk_check": 5,
                "tk_routetrack": True,
                "tk_status": "1 .GPS is positioning,0 Satellite\r\n"
                "2 .Sensor sensitivity: 1\r\n"
                "3 .Alert status: CALL\r\n"
                "4 .Check interval is set to 5 minute(s).\r\n"
                "5 .Routetrack data is uploading, Period is set to 99\r\n"
